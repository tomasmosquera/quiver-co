...
export default async function CuentaMensajesPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-xl font-bold text-[#111827]">Mensajes</h1>
        <p className="text-sm text-[#6B7280] mt-1">Conversaciones con compradores y vendedores.</p>
      </div>
