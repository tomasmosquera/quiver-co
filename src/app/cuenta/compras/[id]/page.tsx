...
export default async function CompraDetailPage({
  ...
  if (!order || order.buyerId !== session.user.id) return notFound();
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-3">
        ...
        >
          <ChevronLeft className="w-4 h-4" /> Mis compras
        </Link>
      </div>

      <div>
        <h1 className="text-xl font-bold text-[#111827]">Detalle de compra</h1>
